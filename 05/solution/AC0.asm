       ...
       extends [mscorlib]System.Object
{
  ...
  .method public hidebysig static void  ValidateCode(string code) cil managed
  {
    ...
    IL_015a:  ldnull
    IL_015b:  ldnull
    IL_015c:  callvirt   instance void [mscorlib]System.Reflection.Emit.MethodBuilder::SetMethodBody(uint8[],
                                                                                                     int32,
                                                                                                     uint8[],
                                                                                                     [mscorlib]System.Collections.Generic.IEnumerable`1<[mscorlib]System.Reflection.Emit.ExceptionHandler>,
